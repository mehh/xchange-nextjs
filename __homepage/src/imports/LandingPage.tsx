...
import imgSocialMediaIcons1 from "figma:asset/6a30b3ccdebfd665dd1f1b3627a2663a195c81e1.png";
import imgTModHomesPageHealthyLiving1 from "figma:asset/ec0ef60ac25a9bb66629761953013857711101f6.png";
import imgHomeAmericanFlag1 from "figma:asset/fae8309e43a3c34f5828b3625bf2aa57f63c8d8d.png";
import imgTModHomePageBetterWaytoBuild1 from "figma:asset/b082f62ea4b59acf903bbf73674d055ec2fc6e33.png";
import imgTmodLogo1 from "figma:asset/424fe691d2e133bf65723770b2e18f23ba6d8069.png";
import imgTModHomePageTheDreamTeam1 from "figma:asset/baf75f6314c1f974e3cef252eba31c788e31fe51.png";
import imgMcArrow1 from "figma:asset/33c77a449be6ec80d056fd42dda2a2fdc5944be8.png";
import imgTModHomePageDreamTeamOffice1 from "figma:asset/e8ca0cfb3c3458df280358144522ec1e2445fca9.png";

function Group1() {
  return (
    <div className="absolute contents left-0 top-[4707px]">
      <div className="absolute bg-[#272719] h-[372px] left-0 top-[4707px] w-[1440px]" />
      <div className="absolute font-['Montserrat:Regular',_sans-serif] leading-[0] left-40 not-italic text-[13px] text-nowrap text-white top-[4794px]">
        <p className="leading-[normal] whitespace-pre">Homes</p>
      </div>
      <div className="absolute font-['Montserrat:Regular',_sans-serif] leading-[0] left-40 not-italic text-[13px] text-nowrap text-white top-[4816px]">
        <p className="leading-[normal] whitespace-pre">Health</p>
      </div>
      <div className="absolute font-['Montserrat:Regular',_sans-serif] leading-[0] left-40 not-italic text-[13px] text-nowrap text-white top-[4838px]">
        <p className="leading-[normal] whitespace-pre">Team</p>
      </div>
      <div className="absolute font-['Montserrat:Regular',_sans-serif] leading-[0] left-[161px] not-italic text-[13px] text-nowrap text-white top-[4978px]">
        <p className="leading-[normal] whitespace-pre">© 2025 TMOD, Inc. All rights reserved</p>
      </div>
      <div className="absolute font-['Montserrat:Regular',_sans-serif] leading-[0] left-[675px] not-italic text-[13px] text-nowrap text-white top-[4978px]">
        <p className="leading-[normal] whitespace-pre">Privacy Policy</p>
      </div>
      <div className="absolute font-['Montserrat:Regular',_sans-serif] leading-[0] left-[1199px] not-italic text-[13px] text-nowrap text-white top-[4978px]">
        <p className="leading-[normal] whitespace-pre">Terms of Use</p>
      </div>
      <div className="absolute bg-[1.53%_0%] bg-no-repeat bg-size-[126.78%_100%] h-8 left-[1190px] top-[4788px] w-[104px]" data-name="SocialMedia_Icons 1" style={{ backgroundImage: `url('${imgSocialMediaIcons1}')` }} />
    </div>
  );
}
...
function Group4() {
  return (
    <div className="absolute left-[882px] size-11 top-[662px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
        <g id="Group 4">
          <path d={svgPaths.p1a6a9000} fill="var(--stroke-0, white)" id="Arrow 1" />
...
function Frame1() {
  return (
    <div className="absolute h-[3057px] left-[-23px] top-0 w-[1575px]">
      <div className="absolute bg-center bg-cover bg-no-repeat h-[478px] left-0 top-[2579px] w-[1575px]" data-name="TMod_HomesPage_HealthyLiving 1" style={{ backgroundImage: `url('${imgTModHomesPageHealthyLiving1}')` }} />
      <div className="absolute bg-[51.76%_77.7%] bg-no-repeat bg-size-[106.27%_122.36%] h-[662px] left-[67px] top-28 w-[1352px]" data-name="Home_AmericanFlag 1" style={{ backgroundImage: `url('${imgHomeAmericanFlag1}')` }} />
      <div className="absolute bg-white h-28 left-[23px] top-0 w-[1440px]" />
      ...
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[690px] not-italic text-[18px] text-nowrap text-white top-[2907px]">
      ...
      <div className="absolute bg-center bg-cover bg-no-repeat h-[674px] left-[692px] top-[1863px] w-[771px]" data-name="TMod_HomePage_BetterWaytoBuild 1" style={{ backgroundImage: `url('${imgTModHomePageBetterWaytoBuild1}')` }} />
      <div className="absolute bg-[#595e48] h-[608px] left-[23px] top-[1213px] w-[1440px]" />
      <div className="absolute font-['Oswald:Medium',_sans-serif] font-medium leading-[0] left-[692px] text-[19px] text-black text-nowrap top-[858px]">
        <p className="leading-[normal] whitespace-pre">WE BELIEVE IN</p>
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[462px] not-italic text-[55px] text-black text-nowrap top-[889px]">
        <p className="leading-[normal] whitespace-pre">A Better Way to Live</p>
      </div>
      <div className="absolute font-['Montserrat:Regular',_sans-serif] leading-[normal] not-italic text-[15px] text-black text-center top-[974px] translate-x-[-50%] w-[844px]" style={{ left: "calc(50% - 44.5px)" }}>
      ...
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[570px] not-italic text-[44px] text-nowrap text-white top-[1317px]">
      ...
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[690px] not-italic text-[18px] text-nowrap text-white top-[1670px]">
        <p className="leading-[normal] whitespace-pre">Learn more</p>
      </div>
      <div className="absolute bg-[rgba(0,0,0,0)] h-[51px] left-[758px] rounded-[29px] top-[2273px] w-[305px]">
        <div aria-hidden="true" className="absolute border-2 border-solid border-white inset-0 pointer-events-none rounded-[29px]" />
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[797px] not-italic text-[18px] text-nowrap text-white top-[2288px]">
        <p className="leading-[normal] whitespace-pre">Watch how we do it</p>
      </div>
      <div className="absolute font-['Oswald:Medium',_sans-serif] font-medium leading-[0] left-[165px] text-[19px] text-black text-nowrap top-[2010px]">
        <p className="leading-[normal] whitespace-pre">WE BELIEVE IN</p>
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[normal] left-[165px] not-italic text-[55px] text-black text-nowrap top-[2045px] whitespace-pre">
        <p className="mb-0">A Better</p>
        <p>Way to Build</p>
      </div>
      <div className="absolute font-['Montserrat:Regular',_sans-serif] h-[161px] leading-[normal] left-[165px] not-italic text-[15px] text-black top-[2220px] w-[431px]">
      ...
      <div className="absolute font-['Montserrat:Medium',_sans-serif] h-[161px] leading-[normal] left-[758px] not-italic text-[28px] text-white top-[2058px] w-[601px]">
      ...
      <div className="absolute bg-center bg-cover bg-no-repeat h-[52px] left-[67px] top-[30px] w-24" data-name="TMOD_Logo 1" style={{ backgroundImage: `url('${imgTmodLogo1}')` }} />
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[264px] not-italic text-[12px] text-black text-nowrap top-12">
        <p className="leading-[normal] whitespace-pre">Homes</p>
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[882px] not-italic text-[17px] text-nowrap text-white top-[597px]">
        <p className="leading-[normal] whitespace-pre">one truly affordable home at a time...</p>
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[normal] left-[882px] not-italic text-[56px] text-nowrap text-white top-[458px] whitespace-pre">
        <p className="mb-0">Restoring the</p>
        <p>American Dream</p>
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[336px] not-italic text-[12px] text-black text-nowrap top-12">
        <p className="leading-[normal] whitespace-pre">Health</p>
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[404px] not-italic text-[12px] text-black text-nowrap top-12">
        <p className="leading-[normal] whitespace-pre">Team</p>
      </div>
      <div className="absolute bg-[#595e48] h-[30px] left-[1296px] rounded-[20px] top-[41px] w-[126px]" />
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[1325px] not-italic text-[12px] text-nowrap text-white top-12">
...
export default function LandingPage() {
  return (
    <div className="bg-white relative size-full" data-name="Landing Page">
      <div className="absolute bg-[rgba(0,0,0,0)] h-[46px] left-[858px] rounded-[29px] top-[3457px] w-[197px]">
        <div aria-hidden="true" className="absolute border-2 border-black border-solid inset-0 pointer-events-none rounded-[29px]" />
      </div>
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[904px] not-italic text-[18px] text-black text-nowrap top-[3469px]">
        <p className="leading-[normal] whitespace-pre">Learn more</p>
      </div>
      <div className="absolute bg-center bg-cover bg-no-repeat h-[1046px] left-[849px] top-[3680px] w-[593px]" data-name="TMod_HomePage_TheDreamTeam 1" style={{ backgroundImage: `url('${imgTModHomePageTheDreamTeam1}')` }} />
      ...
      <div className="absolute font-['Montserrat:Medium',_sans-serif] leading-[0] left-[142px] not-italic text-[55px] text-black text-nowrap top-[4201px]">
      ...
      <div className="absolute bg-[rgba(255,255,255,0)] h-[30px] left-[533px] rounded-[3px] top-[3185px] w-[187px]">
        <div aria-hidden="true" className="absolute border border-[#919191] border-solid inset-0 pointer-events-none rounded-[3px]" />
      </div>
      <div className="absolute bg-[rgba(255,255,255,0)] h-[30px] left-[571px] rounded-[3px] top-[3265px] w-[149px]">
        <div aria-hidden="true" className="absolute border border-[#919191] border-solid inset-0 pointer-events-none rounded-[3px]" />
      </div>
      <div className="absolute bg-center bg-cover bg-no-repeat h-[7px] left-[695px] top-[3197px] w-3.5" data-name="MC_Arrow 1" style={{ backgroundImage: `url('${imgMcArrow1}')` }} />
      ...
      <div className="absolute font-['Montserrat:Regular',_sans-serif] h-[180px] leading-[normal] left-[142px] not-italic text-[15px] text-black top-[4313px] w-[618px]">
      ...
      <div className="absolute bg-[rgba(0,0,0,0)] h-[46px] left-[142px] rounded-[46px] top-[4532px] w-[227px]">
        <div aria-hidden="true" className="absolute border-2 border-black border-solid inset-0 pointer-events-none rounded-[46px]" />
      </div>
      ...
      <Group1 />
      <div className="absolute bg-center bg-cover bg-no-repeat h-[396px] left-[95px] top-[3680px] w-[712px]" data-name="TMod_HomePage_DreamTeam_Office 1" style={{ backgroundImage: `url('${imgTModHomePageDreamTeamOffice1}')` }} />
      <Frame1 />
    </div>
  );
}