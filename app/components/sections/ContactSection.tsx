...
export default function ContactSection() {
  ...
  return (
    <section className="relative w-full min-h-[600px] md:min-h-[700px] lg:min-h-[810px] bg-calm overflow-hidden py-16 md:py-24">
      {/* Background decorative elements */}
      <div className="absolute inset-0">
        {/* Main background pattern - responsive */}
        <div className="absolute inset-0 opacity-20">
          <svg
            className="absolute -left-16 md:-left-32 -top-32 md:-top-40 w-full h-full scale-75 md:scale-100"
            width="1440"
            height="810"
        ...
        {/* Blurred circle - responsive positioning */}
        <div
          className="absolute w-[400px] h-[400px] md:w-[600px] md:h-[600px] lg:w-[868px] lg:h-[868px] rounded-full bg-calm left-1/2 transform -translate-x-1/2 -top-8 md:-top-14"
          style={{ filter: 'blur(100px) md:blur(150px) lg:blur(200px)' }}
        />
      </div>

      {/* Content - responsive container */}
      <div className="relative z-10 flex items-center justify-center w-full min-h-[500px] md:min-h-[600px] lg:min-h-[700px] px-4 py-8 md:py-16">
        <div className="w-full max-w-[443px]">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              {/* First Name - with border and populated value */}
              <div className="flex h-14 px-3 py-3 flex-col justify-between flex-1 rounded-lg border border-white/20 bg-white/5">
                <label
                  htmlFor="firstName"
                ...
                <input
                  ...
                  required
                  className="w-full bg-transparent border-none outline-none text-white font-outfit text-[14px] md:text-[16px] font-normal leading-[100%] tracking-[-0.32px] placeholder-white/50"
                />
              </div>
            ...
            {/* Comments */}
            <div className="flex h-[100px] md:h-[124px] px-3 py-3 flex-col rounded-lg bg-white/5">
              <label
                htmlFor="comments"
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows={3}
                className="w-full bg-transparent border-none outline-none text-white font-outfit text-[14px] md:text-[16px] font-normal leading-[120%] tracking-[-0.32px] placeholder-white/50 resize-none"
              />
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="h-12 px-6 rounded-full bg-white text-slate font-outfit text-[14px] md:text-[16px] font-normal leading-[100%] tracking-[-0.32px] uppercase hover:bg-white/90 transition-all duration-300 mt-2"
            >
              Send
            </motion.button>
          </motion.form>
